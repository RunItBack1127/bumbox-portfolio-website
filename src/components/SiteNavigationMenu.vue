<template>
    <header>
        <nav id="navigation-content">
            ...
            <div @click="this.showResponsiveMenu = true" id="responsive-hamburger">
                <button>
            ...
            <aside>
                <header>
                    <div id="responsive-hamburger">
                        <button @click="this.showResponsiveMenu = false">
                            <svg width="30" height="21" viewBox="0 0 30 21">
                                <rect x="0" y="0" width="30" height="1"/>
                                <rect x="0" y="10" width="30" height="1"/>
                                <rect x="0" y="20" width="30" height="1"/>
                ...
                <div id="responsive-content-container">
                    <div id="responsive-menu-contents">
                        <div id="menu-contents-header">
                            <h1>Bumbox</h1>
                            <nav id="navigation-socials">
                                <a href="">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
